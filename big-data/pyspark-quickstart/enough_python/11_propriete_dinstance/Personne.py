...
if __name__ == '__main__':
    print("hola")
    jerry = Personne("Jerry", "John")
    print("nom", jerry.nom)
    print("prenom", jerry.prenom)
    print("lieu de residence", jerry.lieu_residence)
    print(jerry._lieu_residence) #on peut quand meme acceder a un donné protéger et ce n'st pas tres cool
